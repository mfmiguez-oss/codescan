...
const children = [
  ...
  table(
    ...
    [2400, 1400, 5560]),
  P("Two overrides on top of the blend: a KEV floor (anything actively exploited is floored to 85 — exploited-in-the-wild outweighs modelling) and a corroboration bonus (+2 when both scanners agree). This reordering is what makes the queue useful: an unreachable critical drops below a reachable, chainable high."),
